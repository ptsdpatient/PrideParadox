...
public class PrideParadox extends ApplicationAdapter {
    ...
    public static int overButtonActiveIndex=0,kills=0,frameIndex=0,saveIndex=0,pauseButtonActiveIndex=0,menuButtonActiveIndex = 0,loadButtonIndex=0,typewriterIndex=0,currentLevel=0,storyLineIndex=0,lineDepth=0,playerAnimationId=0;
...
//                    print("pop");
        ...
        public  void stayAroundPlayer(float distance,float parameter){
            ...
            deltaY = player.getY() + player.getHeight() / 2 + distance * (float) Math.sin((object.getRotation()+parameter)*MathUtils.radiansToDegrees) - object.getHeight() / 2;
            object.setPosition(deltaX, deltaY);
        }
